...
let topObstacle = new Obstacle({x: canvasWidth, y: 100, width: obstacleWidth, height: obstacleHeight, speed: 7.5});
let bottomObstacle = new Obstacle({x: canvasWidth, y: canvas.height-200, width: obstacleWidth, height: obstacleHeight, speed: 8});
let topObstacle_2 = new Obstacle({x: canvasWidthOffset, y: 200, width: obstacleWidth, height: obstacleHeight});
let bottomObstacle_2 = new Obstacle({x: canvasWidthOffset, y: canvas.height-300, width: obstacleWidth, height: obstacleHeight, speed: 8});
let topObstacle_3 = new Obstacle({x: canvasWidthOffset, y: 0, width: obstacleWidth, height: obstacleHeight, speed: 8, direction: -1});
let bottomObstacle_3 = new Obstacle({x: canvasWidthOffset, y: canvas.height-75, width: obstacleWidth, height: obstacleHeight, speed: 9, direction: 1});
...
let bottomBonusObstacle = new Obstacle({x: canvas.width+100, y: canvas.height-100, width: 50, height: 50, speed: 8});
...
function runGame() {
  ...
  ufo.checkFlight();
  topObstacle.traverse();
  topObstacle_2.traverse();
  topObstacle_4.traverse();
  topObstacle_5.traverse();
  bottomObstacle.traverse();
  bottomObstacle_2.traverse();
  bottomObstacle_4.traverse();
  bottomObstacle_5.traverse();
  topBonusObstacle.traverse();
  bottomBonusObstacle.traverse();
  /////////////////////////////////////
  topObstacle_3.traverse();
  bottomObstacle_3.traverse();
  ///////////////////////////////
  ufo.draw();

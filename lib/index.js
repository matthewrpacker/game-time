...
// var topObstacles = [new Obstacle(canvas.width, 0, 50, 80), new Obstacle(canvas.width, 0, 50, 30), new Obstacle(canvas.width, 0, 50, 150)]
var obstacle2 = new Obstacle(canvas.width, canvas.height-80, 50, 80);
// var bottomObstacles = [new Obstacle(canvas.width, canvas.height-80, 50, 80), new Obstacle(canvas.width, canvas.height-80, 50, 30), new Obstacle(canvas.width, canvas.height-80, 50, 130)]
...
function checkForCollision() {
  obstacles.forEach(function(obstacle){
    if (helicopter.x < obstacle.x + obstacle.width &&
      ...
      helicopter.height + helicopter.y > obstacle.y) {

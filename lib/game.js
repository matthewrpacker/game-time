...
function getGameScores(id) {
  scores = localStorage.getItem('storedScores').split(',');
...
function drawObstacles() {
  context.fillRect(topObstacle.x, topObstacle.y, topObstacle.width, topObstacle.height);
  context.fillRect(bottomObstacle.x, bottomObstacle.y, bottomObstacle.width, bottomObstacle.height);
}
